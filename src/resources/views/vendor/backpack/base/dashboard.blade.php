     ...
     $widgets['before_content'][] = [
	  ...
	  'content' => [ // widgets
		  	[
		        ...
		        // 'class' => 'col-md-6',
		        'controller' => \Backpack\NewsCRUD\app\Http\Controllers\Admin\Charts\WeeklyUsersChartController::class,
				'content' => [
	    	...
	    	[
		        ...
		        'wrapperClass' => 'col-md-6',
		        // 'class' => 'col-md-6',
		        'controller' => \Backpack\NewsCRUD\app\Http\Controllers\Admin\Charts\NewEntriesChartController::class,
				'content' => [
